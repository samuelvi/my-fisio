...
export default function InvoiceForm() {
    ...
    return (
        <div className="max-w-5xl mx-auto space-y-10">
            ...
            <form id="invoice-form" onSubmit={handleSubmit} className="space-y-10 pb-20">
                {/* Master Section */}
                ...
                <div className="bg-white shadow-sm border border-gray-100 rounded-[2.5rem] p-12">
                    ...
                    <div className="mt-12 flex justify-between items-center bg-gray-50 p-10 rounded-[2rem] border-2 border-primary/10 shadow-inner">
                ...
                <div className="flex justify-between items-center bg-white px-8 py-6 rounded-[2.5rem] border border-gray-100 shadow-sm">
                    <button 
                        type="button" 
                    ...
                    <button 
                        type="submit" 
                        disabled={loading} 
                        className="px-10 py-4 bg-btn-success text-white rounded-2xl text-[10px] font-black uppercase tracking-widest hover:brightness-95 shadow-xl shadow-btn-success/20 transition-all disabled:opacity-50 flex items-center"
                    >
