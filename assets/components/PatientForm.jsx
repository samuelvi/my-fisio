    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <form id="patient-form" onSubmit={handleSubmit} className="space-y-6 pb-20">
                ...
                {isEditing && (
                    <div className="bg-red-50 shadow px-4 py-5 sm:rounded-lg sm:p-6 border border-red-200 mt-12 mb-12">
                        <div className="md:grid md:grid-cols-3 md:gap-6">
                            <div className="md:col-span-1">
                ...
                <div className="flex justify-between items-center bg-gray-50 px-6 py-4 sm:rounded-lg border border-gray-200 shadow-sm mt-8">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="inline-flex items-center px-8 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none disabled:opacity-50"
                    >
