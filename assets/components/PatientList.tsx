        ...
        <div className="p-4 sm:p-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200">
                            ...
                            {patients.map((patient) => (
                                    ...
                                    <td className="px-4 lg:px-8 py-5 whitespace-nowrap text-right text-sm font-bold">
                                        <div className="flex items-center justify-end gap-3">
                                            <Link
                                                ...
                                                className="patient-appointments-btn text-gray-400 hover:text-primary transition-colors inline-flex items-center"
                                            ...
                                            <Link
                                                ...
                                                className="patient-invoice-btn text-gray-400 hover:text-gray-600 transition-colors inline-flex items-center"
                                ...
                                >
                                            ...
                                            <Link
                                                ...
                                                className="patient-edit-btn text-gray-400 hover:text-gray-600 transition-colors inline-flex items-center"
                                                title={t('edit')}
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="md:hidden divide-y divide-gray-100">
                    {patients.map((patient) => (
                        <div key={patient.id} className="border-b border-gray-100">
                            ...
                            <div className="px-4 pb-3 flex flex-wrap gap-2">
                                <Link
                                    to={`/patients/${patient.id}/appointments`}
                                    className="patient-appointments-btn flex-1 text-center bg-gray-50 text-gray-700 px-3 py-2.5 rounded-lg font-bold border border-gray-200 hover:bg-gray-100 transition-colors text-sm inline-flex items-center justify-center gap-1.5"
                                >
                                ...
                                <Link
                                    to={`/invoices/new?patientId=${patient.id}`}
                                    className="patient-invoice-btn flex-1 text-center bg-gray-50 text-gray-700 px-3 py-2.5 rounded-lg font-bold border border-gray-200 hover:bg-gray-100 transition-colors text-sm inline-flex items-center justify-center gap-1.5"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                    </svg>
                                ...
                                <Link
                                    to={`/patients/${patient.id}/edit`}
                                    className="patient-edit-btn flex-1 text-center bg-gray-50 text-gray-700 px-3 py-2.5 rounded-lg font-bold border border-gray-200 hover:bg-gray-100 transition-colors text-sm inline-flex items-center justify-center gap-1.5"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
