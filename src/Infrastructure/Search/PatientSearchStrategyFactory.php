...
final class PatientSearchStrategyFactory
{
    ...
    public static function create(Connection $connection): PatientSearchStrategyInterface
    {
        ...
        return match (true) {
            ...
            $platform instanceof PostgreSQLPlatform => new PostgreSQLPatientSearchStrategy(),
            default => throw new RuntimeException(
                sprintf(
                    'Unsupported database platform "%s". Supported platforms: MariaDB, MySQL, PostgreSQL.',
                    $platformClass
                )
            ),
        };
