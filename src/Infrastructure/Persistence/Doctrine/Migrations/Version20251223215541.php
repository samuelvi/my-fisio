...
/**
 * Initial migration - unified schema with CITEXT for case-insensitive search.
 */
final class Version20251223215541 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial migration: Unified schema with CITEXT support for case-insensitive searching.';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT GENERATED BY DEFAULT AS IDENTITY NOT NULL, email CITEXT NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY (id))');
