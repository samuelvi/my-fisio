 ...
 */
final class Version20260130190429 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE appointments (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, all_day TINYINT DEFAULT NULL, starts_at DATETIME NOT NULL, ends_at DATETIME NOT NULL, type VARCHAR(255) DEFAULT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, patient_id INT DEFAULT NULL, INDEX IDX_6A41727A6B899279 (patient_id), INDEX idx_appointments_starts_at (starts_at), INDEX idx_appointments_ends_at (ends_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE audit_trail (id BIGINT AUTO_INCREMENT NOT NULL, entity_type VARCHAR(100) NOT NULL, entity_id VARCHAR(100) NOT NULL, operation VARCHAR(20) NOT NULL, changes JSON NOT NULL, changed_at DATETIME NOT NULL, ip_address VARCHAR(45) DEFAULT NULL, user_agent LONGTEXT DEFAULT NULL, changed_by INT DEFAULT NULL, INDEX IDX_B523E17810BC6D9F (changed_by), INDEX idx_entity (entity_type, entity_id, changed_at), INDEX idx_operation (operation, changed_at), INDEX idx_changed_by (changed_by, changed_at), INDEX idx_changed_at (changed_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE customers (id INT AUTO_INCREMENT NOT NULL, first_name VARCHAR(100) NOT NULL, last_name VARCHAR(100) NOT NULL, full_name VARCHAR(255) DEFAULT NULL, tax_id VARCHAR(20) NOT NULL, email VARCHAR(180) DEFAULT NULL, phone VARCHAR(50) DEFAULT NULL, billing_address LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_62534E21B2A824D8 (tax_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE event_store (id BIGINT AUTO_INCREMENT NOT NULL, aggregate_id VARCHAR(36) NOT NULL, event_name VARCHAR(255) NOT NULL, payload JSON NOT NULL, occurred_on DATETIME NOT NULL, version INT NOT NULL, INDEX idx_es_aggregate_id (aggregate_id), INDEX idx_es_event_name (event_name), INDEX idx_es_occurred_on (occurred_on), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
